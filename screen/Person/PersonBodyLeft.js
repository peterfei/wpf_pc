...
class PersonBodyLeft extends Component {
  state = {
    ...
    Image: [
      { Image: require("../img/tab1.png") },
      { Image: require("../img/tab2.png") },
      { Image: require("../img/tab3.png") },
      { Image: require("../img/tab4.png") }
    ],
    userName: "",
    mbHeadUrl: ""
  };
      ...
      <View style={[color.rightBackground, styles.container]}>
        <View style={[styles.personInformation, color.borderBottom]}>
          <Image
            ...
            source={
              this.state.mbHeadUrl !== ""
                ? { uri: this.state.mbHeadUrl }
                : require("../img/text.jpg")
            }
          />
