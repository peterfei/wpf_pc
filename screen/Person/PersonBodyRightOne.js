...
class PersonBodyRightOne extends Component {
  ...
  async componentDidMount() {
    ...
    let mbHeadUrl =
      member.mbHeadUrl == "RYKJ/" || member.mbHeadUrl == null
        ? ""
        : member.mbHeadUrl;
      ...
      <View style={styles.mainBody}>
        ...
        <View style={styles.row}>
          <View style={[styles.mainBodyContent, { width: "50%" }]}>
            <Text style={[font.font20NoBold, styles.mainBodyContentLeft]}>
              姓名：
            </Text>
            <TextInput
            ...
            />
            <Text
              style={[font.font20Blue, styles.textButton]}
              onPress={() => {
        ...
        <View style={styles.row}>
          <View style={[styles.mainBodyContent, { width: "50%" }]}>
            ...
            <Text style={[font.font18]}>
              {this.state.phoneNumber.slice(0, 6) + "*****"}
            </Text>
          </View>
          <View style={[styles.mainBodyContent, { width: "50%" }]}>
  ...
  radioModal() {
    return (
      <RadioModal
        ...
        <Text value="0" style={{ width: 100 }}>
          男
        </Text>
        <Text value="1" style={{ width: 100 }}>
          女
        </Text>
      </RadioModal>
    );
