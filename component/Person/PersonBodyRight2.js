  ...
  render() {
    ...
    changePasswordView(){
      if(this.state.changePassword){
        return(
        <View style={{position:'absolute',top:70,zIndex:999,backgroundColor:'white'}}>
          <View style={{borderWidth:1,borderColor:'white',width:300,height:300}}>
            <Image
